        ...
        <div className="max-w-6xl mx-auto px-4 py-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex-1">
              <h1 className="text-2xl font-bold">End Shift - Quick Record</h1>
          ...
          <div className="max-w-6xl mx-auto p-4 space-y-8">
            ...
            {salesLogs.length > 0 && (
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-200/50 shadow-sm">
                <h2 className="text-2xl font-bold mb-4 flex items-center gap-3 text-green-800">
                  <div className="bg-green-100 p-3 rounded-xl">
                    <TrendingUp className="h-6 w-6 text-green-600" />
                  </div>
                  Recorded Sales
                </h2>
                <div className="space-y-3 max-h-64 overflow-y-auto border rounded-xl p-4 bg-white/80 backdrop-blur-sm">
                  {salesLogs.map((log) => (
                    <div key={log.id} className="flex justify-between items-center p-4 bg-white rounded-xl shadow-sm border border-green-100/50 hover:shadow-md transition-all duration-200">
                      <div>
                        <p className="font-medium text-base">{log.bread_types?.name || 'Unknown'}</p>
                      ...
                      <div className="text-right">
                        <p className="font-bold text-base">{log.quantity} units</p>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200/50 shadow-sm">
              ...
              <div className="space-y-4">
                {quickRecordItems.map((item) => (
                  <div key={item.breadType.id} className="flex items-center justify-between p-4 border rounded-xl bg-white/80 backdrop-blur-sm hover:shadow-md transition-all duration-200 hover:bg-white touch-manipulation min-h-[80px]">
                    <div className="flex-1">
                      <p className="font-medium text-base">{item.breadType.name}</p>
                    ...
                    <div className="flex items-center gap-3">
                      <Button
                        ...
                        className="h-12 w-12 p-0 rounded-full hover:bg-red-50 hover:border-red-200 transition-colors touch-manipulation"
                      >
                      ...
                      <input
                        ...
                        className="w-20 h-12 text-center border rounded-xl px-3 py-2 font-semibold focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-base touch-manipulation"
                        placeholder="0"
                      />
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => updateQuickRecordQuantity(item.breadType.id, item.quantity + 1)}
                        className="h-12 w-12 p-0 rounded-full hover:bg-green-50 hover:border-green-200 transition-colors touch-manipulation"
                      >
            ...
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-6 border border-amber-200/50 shadow-sm">
              ...
              <div className="space-y-4">
                {quickRemainingItems.map((item) => (
                  <div key={item.breadType.id} className="flex items-center justify-between p-4 border rounded-xl bg-gradient-to-r from-yellow-50/80 to-amber-50/80 backdrop-blur-sm hover:shadow-md transition-all duration-200 hover:from-yellow-100/80 hover:to-amber-100/80 touch-manipulation min-h-[80px]">
                    <div className="flex-1">
                      <p className="font-medium text-base">{item.breadType.name}</p>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <input
                        ...
                        className="w-20 h-12 text-center border rounded-xl px-3 py-2 font-semibold focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all text-base touch-manipulation"
                        placeholder="0"
                      />
                      <Button
                        variant="outline"
      ...
      <div className="bg-white border-t border-gray-200 p-4 flex-shrink-0">
        <div className="max-w-6xl mx-auto flex gap-4">
          <Button
            ...
            onClick={() => router.back()}
            disabled={submitting}
            className="flex-1 py-4 rounded-2xl border-2 hover:border-blue-400 transition-all duration-200 text-base font-semibold touch-manipulation min-h-[56px]"
          >
            Cancel
          </Button>
          <Button
            ...
            className="flex-1 py-4 rounded-2xl bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-lg hover:shadow-xl touch-manipulation min-h-[56px]"
          >
            {submitting ? (
              ...
              <div className="p-6">
                ...
                <div className="flex gap-4">
                  <Button
                    ...
                    className="flex-1 text-base font-semibold touch-manipulation min-h-[48px]"
                  >
                    Cancel
                  </Button>
                  <Button
                    onClick={handleConfirmProceed}
                    className="flex-1 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-base font-semibold touch-manipulation min-h-[48px]"
                  >
                    Proceed
                  </Button>
                </div>
            ...
            >
              <div className="p-6">
                ...
                <textarea
                  ...
                  className="w-full h-32 p-3 border rounded-xl resize-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-base touch-manipulation"
                />
                <div className="flex gap-4 mt-6">
                  ...
                  <Button
                    ...
                    disabled={submitting}
                    className="flex-1 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 touch-manipulation min-h-[48px]"
                  >
                    {submitting ? (
                      <div className="flex items-center justify-center gap-2">
                        <div className="rounded-full h-4 w-4 border-2 border-white border-t-transparent animate-spin" />
                        <span className="text-base font-semibold">Submitting...</span>
                      </div>
                    ) : (
                      <span className="text-base font-semibold">Submit Report</span>
                    )}
