            ...
            <div className="space-y-3 sm:space-y-4">
              {filtered.map((report, index) => (
                <motion.div
                  ...
                  className="bg-white/80 backdrop-blur-sm rounded-lg p-3 sm:p-4 border border-green-200/50 shadow-sm hover:shadow-lg hover:border-green-300 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 cursor-pointer"
                  onClick={() => handleViewReport(report)}
                  role="button"
                  tabIndex={0}
                  aria-label={`View ${report.shift} shift sales report for ${formatDate(report.report_date)}`}
                  onKeyDown={(e) => {
                ...
                >
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-gray-100">
                    ...
                    <div className="flex gap-1">
                      <div className="p-2 text-green-500 bg-green-50 rounded-lg text-xs font-medium pointer-events-none flex items-center gap-1">
                        <Eye size={12} />
