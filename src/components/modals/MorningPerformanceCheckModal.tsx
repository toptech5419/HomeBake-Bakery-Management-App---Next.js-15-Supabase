...
export function MorningPerformanceCheckModal({ isOpen, onClose }: MorningPerformanceCheckModalProps) {
  // Force morning shift for this modal
    ...
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-start justify-center p-4 overflow-y-auto">
        <div className="min-h-full w-full flex items-start justify-center py-4">
          ...
          >
          {/* Modal Header - Fixed */}
          <div className="flex items-center justify-between p-6 border-b border-gray-100 bg-gradient-to-r from-orange-50 to-amber-50 flex-shrink-0">
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
                ...
                Morning Shift Production Items
              </h3>
              <button
            ...
            <ErrorBoundary>
              <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-200">
                <div className="bg-gray-50 px-4 py-4 border-b border-gray-200 font-semibold text-gray-700 text-sm flex items-center justify-between">
                  <div>
                    Production Items for Morning Shift
