-- FINAL CLEAN FIX FOR JSONB CASTING ERROR
-- This properly drops all existing policies first, then recreates everything
...
-- ============================================================================
-- STEP 2: Drop and recreate the function with proper JSONB handling
-- ============================================================================
...
-- ============================================================================
-- STEP 3: CREATE ALL RLS POLICIES WITH FIXED FUNCTION
-- ============================================================================
...
-- PRODUCTION LOGS TABLE POLICIES (FIXES RLS VIOLATION)
...
SELECT 'Testing RLS System...' as status;
SELECT * FROM test_rls_system();

-- Test role function directly
SELECT 'Testing Role Function...' as status;
